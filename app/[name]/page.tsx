      ...
      <div className="flex flex-col max-w-[1000px] w-full mx-auto justify-between gap-12 p-10 rounded-lg border border-[#272727] bg-[#171717]">
        ...
        <div className="grid grid-rows-3 sm:grid-rows-none sm:grid-cols-3 gap-8">
          <div className="flex flex-col items-center gap-4">
            <h3 className="text-xl font-semibold" style={{color: data.color}}>{data.serviceName1}</h3>
          ...
          <div className="flex flex-col items-center gap-4">
            <h3 className="text-xl font-semibold" style={{color: data.color}}>{data.serviceName2}</h3>
          ...
          <div className="flex flex-col items-center gap-4">
            <h3 className="text-xl font-semibold" style={{color: data.color}}>{data.serviceName3}</h3>
