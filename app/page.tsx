...
export default function Home() {
  return (
    <main className="flex flex-col items-center">
      <div className="flex min-h-[400px] md:min-h-[800px] h-full w-full flex-col justify-end bg-black py-10 px-10 md:px-20 gap-5">
      ...
      <video poster='image/beyond.jpg' className="flex md:min-h-[700px] h-full w-full" playsInline autoPlay loop muted>
